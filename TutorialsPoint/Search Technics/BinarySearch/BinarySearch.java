...
public class BinarySearch{
  ...
  private static int value, mid_index, low_index = 0, highest_index = 15;
  ...
  public static void main(String[] args) {
    ...
    while(found){
      mid_index = low_index + ( (highest_index - low_index) /2 );
      System.out.println(mid_index + " " + highest_index + " " + low_index);
